...
class Student
{
    public  static String[] courseName={"Linear Algebra","Data Structures","Computer Arhitecture","Discrete Structures","OOP","Economics for Engineers","DSLab","OOPLab","EVS"};
    ...
    public static void main(String args[]) throws InvalidRollNoException, Exception {
        ...
        try {
            if (choice == 1) {
                ...
                if (month == 1) {
                    BufferedReader csv = new BufferedReader(new FileReader("D:\\SEM3\\java project\\Attendance - October.csv"));
                    String csvsplit = ",";
                    try {
                        String m;
                    ...
                    BufferedReader csv = new BufferedReader(new FileReader("D:\\SEM3\\java project\\Attendance - September.csv"));
                    String csvsplit = ",";
                    try {
                        String m;
                        while ((m = csv.readLine()) != null) {
                    ...
                    BufferedReader csv = new BufferedReader(new FileReader("D:\\SEM3\\java project\\Attendance - August.csv"));
                    String csvsplit = ",";
                    try {
                        String m;
                        while ((m = csv.readLine()) != null) {
                ...
                System.out.println("ENTER :");
                System.out.println("        11-REGULAR");
                System.out.println("        12-IAS");
